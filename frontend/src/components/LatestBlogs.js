          ...
          <div className="article-card-container position-relative">
            <Slider {...settings} className="common-slider">
              {blogItems.map((item, idx) => (
                <div key={idx} className="article-slick-item" >
                  <div className="article-card bg-transparent p-0 shadow-none">
                    <a className="article-card-img-wrapper" href={item.link}>
                      <img src={item.img} alt="blog-thumb" className="article-card-img rounded" />
                      <span className="article-tag article-tag-absolute rounded">{item.tag}</span>
                    </a>
                    ...
                    <h2 className="article-card-heading heading_18">
                      <a className="heading_18" href={item.link}>{item.title}</a>
                    </h2>
                  </div>
                </div>
              ))}
