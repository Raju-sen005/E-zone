          ...
          <nav className="site-navigation">
            <ul className="main-menu list-unstyled">
              ...
              <li className="menu-list-item nav-item has-dropdown">
                <div className="mega-menu-header">
                  <a className="nav-link active" href="edius11.html">Edius 11</a>
                </div>
              </li>
              {/* Product submenu */}
              <li className="menu-list-item nav-item has-dropdown">
                ...
                <div className="submenu-transform submenu-transform-desktop">
                  ...
                  <ul className="submenu list-unstyled">
                    <li className="menu-list-item nav-item-sub"><a className="nav-link-sub nav-text-sub" href="album-sense.html">Album Sense</a></li>
                    <li className="menu-list-item nav-item-sub"><a className="nav-link-sub nav-text-sub" href="cut-sense.html">Cut Sense</a></li>
                  </ul>
                </div>
              </li>
              {/* About submenu */}
              <li className="menu-list-item nav-item has-dropdown">
                ...
                <div className="submenu-transform submenu-transform-desktop">
                  ...
                  <ul className="submenu list-unstyled">
                    <li className="menu-list-item nav-item-sub"><a className="nav-link-sub nav-text-sub" href="video-editing.html">Video Editing</a></li>
                    <li className="menu-list-item nav-item-sub"><a className="nav-link-sub nav-text-sub" href="gallery.html">Events & Gallery</a></li>
                    <li className="menu-list-item nav-item-sub"><a className="nav-link-sub nav-text-sub" href="download.html">Downloads</a></li>
                    <li className="menu-list-item nav-item-sub"><a className="nav-link-sub nav-text-sub" href="blog.html">Our Blog</a></li>
                  </ul>
                </div>
              </li>
              {/* Contact */}
              <li className="menu-list-item nav-item"><a className="nav-link" href="contact.html">Contact</a></li>
            </ul>
          </nav>

          <ul className="utility-menu list-unstyled">
            <li className="utilty-menu-item">
              <a href="tel:+1-078-2376" className="announcement-text">
            ...
            <li className="utilty-menu-item">
              {userEmail ? (
                <a href="/" onClick={handleLogout} className="announcement-login announcement-text">
                  <span className="utilty-icon-wrapper">{/* user svg */}</span>
                  Logout
                </a>
              ) : (
                <a href="login.html" className="announcement-login announcement-text">
                  <span className="utilty-icon-wrapper">{/* user svg */}</span>
                  Login
                </a>
              )}
            ...
            <li className="utilty-menu-item">
              <a href="wishlist.html" className="header-action-item header-wishlist">
