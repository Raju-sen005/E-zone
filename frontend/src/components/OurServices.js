        ...
        <div class="container">
          ...
          <div class="shop-category-2 shop-category-inner">
            <div class="scattered-item" data-aos="fade-up" data-aos-duration="700">
              <div class="scattered-wrapper">
                <div class="scattered-content">
                  <img class="scattered-img" src="assets/img/products/1.jpg" alt="img" />
                </div>
            ...
            <div class="scattered-item" data-aos="fade-up" data-aos-duration="700">
              <div class="scattered-wrapper">
                <div class="scattered-content">
                  <img class="scattered-img" src="assets/img/products/2.jpg" alt="img" />
                </div>
                <div class="scattered-details">
            ...
            <div class="scattered-item" data-aos="fade-up" data-aos-duration="700">
              <div class="scattered-wrapper">
                <div class="scattered-content">
                  <img class="scattered-img" src="assets/img/products/3.jpg" alt="img" />
                </div>
                <div class="scattered-details">
