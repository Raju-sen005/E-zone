                                ...
                                <nav className="site-navigation">
                                    <ul className="main-menu list-unstyled justify-content-center">
                                        ...
                                        <li className="menu-list-item nav-item has-dropdown">
                                            <Link className="nav-link" to="/edius11">Edius 11</Link>
                                        </li>
                                        <li className="menu-list-item nav-item has-dropdown">
                                            <Link className="nav-link" to="/albumsense">Album Sense</Link>
                                        </li>
                                        <li className="menu-list-item nav-item has-dropdown">
                                            ...
                                            <div className="submenu-transform submenu-transform-desktop">
                                                <ul className="submenu list-unstyled">
                                                    <li className="menu-list-item nav-item-sub"><Link className="nav-link-sub nav-text-sub" to="/albumsense">Album Sense</Link></li>
                                                    <li className="menu-list-item nav-item-sub"><Link className="nav-link-sub nav-text-sub" to="/cutsense">Cut Sense</Link></li>
                                                </ul>
                                            </div>
                                        </li>
                                        <li className="menu-list-item nav-item has-dropdown">
                            ...
                            <div className="col-lg-3 col-md-8 col-8">
                                <div className="header-action d-flex align-items-center justify-content-end">
                                    ...
                                    <Link className="header-action-item header-wishlist ms-4 d-none d-lg-block" to="/wishlist"> <svg class="icon icon-wishlist" width="26" height="22" viewBox="0 0 26 22"
                                        ...
                                        <Link className="header-action-item header-cart ms-4" to="#drawer-cart" data-bs-toggle="offcanvas"><svg class="icon icon-cart" width="24" height="26" viewBox="0 0 24 26" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
