      ...
      <div className="container mt-5 pt-5">
        <div className="row">
          <div className="col-lg-6" data-aos="fade-up">
            <h1 style={{ fontWeight: "900" }}>Why Choose We ?</h1>
            <img
          ...
          <div className="col-lg-6 pt-5">
            ...
            <h5 style={{ fontWeight: "900" }} data-aos="fade-up" data-aos-duration="1100">
            ...
            <h5 style={{ fontWeight: "900" }} data-aos="fade-up" data-aos-duration="1300">
            ...
            <h6 style={{ fontWeight: "900" }} data-aos="fade-up" data-aos-duration="1500">
