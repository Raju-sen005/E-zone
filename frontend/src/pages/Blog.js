                                ...
                                <div className="row">
                                    <div className="col-lg-4 col-md-6 col-12" >
                                        <div className="article-card bg-transparent p-0 shadow-none">
                                            <Link className="article-card-img-wrapper" href="article.html">
                                                <img src="assets/img/blog/furniture-1.jpg" alt="img"
                                                    className="article-card-img rounded" />

                                                <span className="article-tag article-tag-absolute rounded">Decor</span>
                                            </Link>
                                        ...
                                        <div className="article-card bg-transparent p-0 shadow-none">
                                            <Link className="article-card-img-wrapper" href="article.html">
                                                <img src="assets/img/blog/furniture-2.jpg" alt="img"
                                                    className="article-card-img rounded" />
                                                <span className="article-tag article-tag-absolute rounded">Furniture</span>
                                            </Link>
                                            <p className="article-card-published text_12 d-flex align-items-center">
                                                <span className="article-date d-flex align-items-center">
                                                    <span className="icon-publish">
                                        ...
                                        <div className="article-card bg-transparent p-0 shadow-none">
                                            <Link className="article-card-img-wrapper" href="article.html">
                                                <img src="assets/img/blog/furniture-3.jpg" alt="img"
                                                    className="article-card-img rounded" />
                                                <span className="article-tag article-tag-absolute rounded">Kitchen</span>
                                            </Link>
                                            <p className="article-card-published text_12 d-flex align-items-center">
                                                <span className="article-date d-flex align-items-center">
                                                    <span className="icon-publish">
