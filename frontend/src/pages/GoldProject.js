                                    ...
                                    <div className="product-gallery product-gallery-vertical d-flex">
                                        ...
                                        "asNavFor": ".img-thumb-slider"
                                                ...
                                                <div className="img-large-wrapper">
                                                    <a href="assets/img/products/as-1.png" data-fancybox="gallery">
                                                        <img src="assets/img/products/as-1.png" alt="img" />
                                                    </a>
                                                </div>
                                                <div className="img-large-wrapper">
                                                    <a href="assets/img/products/as-2.jpg" data-fancybox="gallery">
                                                        <img src="assets/img/products/as-2.jpg" alt="img" />
                                                    </a>
                                                </div>
                                                <div className="img-large-wrapper">
                                                    <a href="assets/img/products/as-3.jpg" data-fancybox="gallery">
                                                        <img src="assets/img/products/as-3.jpg" alt="img" />
                                                    </a>
                                                </div>
                                                <div className="img-large-wrapper">
                                                    <a href="assets/img/products/as-4.jpg" data-fancybox="gallery">
                                                        <img src="assets/img/products/as-4.jpg" alt="img" />
                                                    </a>
                                                </div>
                                                <div className="img-large-wrapper">
                                                    <a href="assets/img/products/as-5.jpg" data-fancybox="gallery">
                                                        <img src="assets/img/products/as-5.jpg" alt="img" />
                                                    </a>
                                                </div>
                                                <div className="img-large-wrapper">
                                                    <a href="assets/img/products/as-6.jpg" data-fancybox="gallery">
                                                        <img src="assets/img/products/as-6.jpg" alt="img" />
                                                    </a>
                                                </div>

                                                <div className="img-large-wrapper">
                                                    <a href="assets/img/products/as-7.png" data-fancybox="gallery">
                                                        <img src="assets/img/products/as-7.png" alt="img" />
                                                    </a>
                                                </div>

                                                <div className="img-large-wrapper">
                                                    <a href="assets/img/products/as-8.jpg" data-fancybox="gallery">
                                    ...
                                    <div className="product-details ps-lg-4">
                                        ...
                                        <form className="product-form" action="#">
                                            <div
                                                ...
                                                <a href="cart.html" className="position-relative btn-atc btn-add-to-cart loader"
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-5 col-md-12 col-12">
                                            <div className="desc-img">
                                                <img src="assets/img/products/edit-zone-gold-projects.png" alt="img" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="product-card shadow-sm">
                                        <div className="product-card-img text-center">
                                            ...
                                            <div className="product-card-action product-card-action-2">
                                                ...
                                                <a href="cart.html" className="addtocart-btn btn-primary"
                                                    onclick="addToCart('Edius 11')">ADD TO CART</a>
                                            </div>
