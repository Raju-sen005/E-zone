                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                ...
                                <div className="product-card shadow p-4">
                                    <div className="product-card-img">
                                        <a className="hover-switch" href="edius11.html">
                                        ...
                                        <div className="product-card-action product-card-action-2 justify-content-center">
                                            ...
                                            <a href="wishlist.html" className="action-card action-wishlist">
                                            ...
                                            <a href="cart.html" className="action-card action-addtocart">
                                    ...
                                    <div className="product-card-details">
                                        <h3 className="product-card-title">
                                            <a href="edius11.html">Edius 11</a>
                                        </h3>
                            ...
                            <div className="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                ...
                                <div className="product-card shadow p-4">
                                    <div className="product-card-img">
                                        <a className="hover-switch" href="cut-sense.html">
                                    ...
                                    <div className="product-card-details">
                                        <h3 className="product-card-title">
                                            <a href="cut-sense.html">Cut Sense</a>
                                        </h3>
                                        <div className="product-card-price">
                            ...
                            <div className="col-lg-4 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                ...
                                <div className="product-card shadow p-4">
                                    <div className="product-card-img">
                                        <a className="hover-switch" href="album-sense.html">
                                    ...
                                    <div className="product-card-details">
                                        <h3 className="product-card-title">
                                            <a href="album-sense.html">Album Sense</a>
                                        </h3>
                                        <div className="product-card-price">
                                            <span className="card-price-regular">₹1529</span>
                                            <span className="card-price-compare text-decoration-line-through">₹1759</span>
