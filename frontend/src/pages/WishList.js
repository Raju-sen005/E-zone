                    ...
                    <div className="container">
                        ...
                        <div className="row">
                                ...
                                <div className="product-card shadow p-4">
                                    <div className="product-card-img">
                                        <Link className="hover-switch" href="edius11.html">
                                            <img className="primary-img" src="assets/img/products/grass-valley-edius-11.png"
                                                alt="product-img"/>
                                        </Link>
                                    ...
                                    <div className="product-card-details">
                                        <h3 className="product-card-title">
                                            <Link to="/edius11" style={{textDecoration:"none"}}>Edius 11</Link>
                                        </h3>
                            ...
                            <div className="col-lg-4 col-md-6 col-6" >
                                ...
                                <div className="product-card shadow p-4">
                                    <div className="product-card-img">
                                        <Link className="hover-switch" href="/cutsense">
                                            <img className="primary-img" src="assets/img/products/cut.png"
                                                alt="product-img"/>
                                        </Link>
                                    ...
                                    <div className="product-card-details">
                                        <h3 className="product-card-title">
                                            <Link to="/cutsense" style={{textDecoration:"none"}}>Cut Sense</Link>
                                        </h3>
                                        <div className="product-card-price">
                            ...
                            <div className="col-lg-4 col-md-6 col-6" >
                                ...
                                <div className="product-card shadow p-4">
                                    <div className="product-card-img">
                                        <Link className="hover-switch" href="/albumsense">
                                            <img className="primary-img" src="assets/img/products/insidelogic-album-sense.png"
                                                alt="product-img"/>
                                        </Link>
                                    ...
                                    <div className="product-card-details">
                                        <h3 className="product-card-title">
                                            <Link to="/albumsense" style={{textDecoration:"none"}}>Album Sense</Link>
                                        </h3>
                                        <div className="product-card-price">
                                            <span className="card-price-regular">₹1529</span>
                                            <span className="card-price-compare text-decoration-line-through">₹1759</span>
