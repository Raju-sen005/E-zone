                            ...
                            <div className="article-rte">
                                ...
                                <div className="article-meta">
                                    ...
                                    <div className="article-card-published text_14 d-flex align-items-center">
                                        ...
                                        <a href="article.html" className="article-date d-none d-sm-flex align-items-center">
                                ...
                                <div className="next-prev-article mt-5 d-flex align-items-center justify-content-between">
                                    <a href="article.html" className="article-btn prev-article-btn mt-2">PREV ARTICLE</a>
                                    <a href="article.html" className="article-btn next-article-btn active mt-2">NEXT ARTICLE</a>
                                </div>
                            ...
                            <div className="filter-drawer blog-sidebar">
                                <div className="filter-widget widget-blogger text-center">
                                    <div className="blogger-img mb-3">
                                        <img className="rounded" src="assets/img/people/blogger.jpg" alt="img"/>
                                    </div>
                                    ...
                                    <div className="filter-related">
                                        <div className="related-item related-item-article d-flex">
                                            <div className="related-img-wrapper">
                                                <img className="related-img" src="assets/img/blog/furniture-1.jpg" alt="img"/>
                                            </div>
                                        ...
                                        <div className="related-item related-item-article d-flex">
                                            <div className="related-img-wrapper">
                                                <img className="related-img" src="assets/img/blog/furniture-2.jpg" alt="img"/>
                                            </div>
                                            <div className="related-product-info">
                                                <h2 className="related-heading text_14">
                                        ...
                                        <div className="related-item related-item-article d-flex">
                                            <div className="related-img-wrapper">
                                                <img className="related-img" src="assets/img/blog/furniture-3.jpg" alt="img"/>
                                            </div>
                                            <div className="related-product-info">
                                                <h2 className="related-heading text_14">
                                        ...
                                        <div className="related-item related-item-article d-flex">
                                            <div className="related-img-wrapper">
                                                <img className="related-img" src="assets/img/blog/furniture-4.jpg" alt="img"/>
                                            </div>
                                            <div className="related-product-info">
                                                <h2 className="related-heading text_14">
                                        ...
                                        <div className="related-item related-item-article d-flex">
                                            <div className="related-img-wrapper">
                                                <img className="related-img" src="assets/img/blog/furniture-5.jpg" alt="img"/>
                                            </div>
                                            <div className="related-product-info">
                                                <h2 className="related-heading text_14">
                                ...
                                <div className="filter-widget">
                                    ...
                                    <ul className="filter-tags list-unstyled">
                                        <li className="tag-item"><a href="/">Popular</a></li>
                                        <li className="tag-item"><a href="/">Agency</a></li>
                                        <li className="tag-item"><a href="/">Furniture</a></li>
                                        <li className="tag-item"><a href="/">creative</a></li>
                                        <li className="tag-item"><a href="/">design</a></li>
                                        <li className="tag-item"><a href="/">modern</a></li>
                                        <li className="tag-item"><a href="/">UX</a></li>
                                        <li className="tag-item"><a href="/">web</a></li>
                                        <li className="tag-item"><a href="/">bag</a></li>
                                        <li className="tag-item"><a href="/">shoe</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
