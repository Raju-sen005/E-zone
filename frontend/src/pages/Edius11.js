                    ...
                    <div className="row">
                                ...
                                <div className="product-img-large">
                                    <div className="img-large-slider common-slider" data-slick='{
                                        ...
                                        <div className="img-large-wrapper">
                                            <Link to="assets/img/products/edius-5.jpg" data-fancybox="gallery">
                                                <img src="assets/img/products/edius-5.jpg" alt="img"/>
                                            </Link>
                                        </div>
                                        <div className="img-large-wrapper">
                                            <Link to="assets/img/products/edius-2.jpg" data-fancybox="gallery">
                                                <img src="assets/img/products/edius-2.jpg" alt="img"/>
                                            </Link>
                                        </div>
                                        <div className="img-large-wrapper">
                                            <Link to="assets/img/products/edius-3.jpg" data-fancybox="gallery">
                                                <img src="assets/img/products/edius-3.jpg" alt="img"/>
                                            </Link>
                                        </div>
                                        <div className="img-large-wrapper">
                                            <Link to="assets/img/products/edius-4.jpg" data-fancybox="gallery">
                                                <img src="assets/img/products/edius-4.jpg" alt="img"/>
                                            </Link>
                                        </div>
                                        <div className="img-large-wrapper">
                                            <Link to="assets/img/products/edius-1.jpg" data-fancybox="gallery">
                                                <img src="assets/img/products/edius-1.jpg" alt="img"/>
                                            </Link>
                                        </div>
                                        <div className="img-large-wrapper">
                                            <Link to="assets/img/products/edius-6.jpg" data-fancybox="gallery">
                                                <img src="assets/img/products/edius-6.jpg" alt="img"/>
                                            </Link>
                                        </div>
                        ...
                        <div className="col-lg-6 col-md-12 col-12">
                            <div className="product-details ps-lg-4">
                                ...
                                <h2 className="product-title mb-3">Edius 11</h2>
                                ...
                                <div className="product-price-wrapper mb-4">
                                    <span className="product-price regular-price">₹1000.00</span>
                                    <del className="product-price compare-price ms-2">₹1500.00</del>
                                </div>
                                <div className="product-sku product-meta mb-1">
                                    <img src="assets/img/products/Grass-Valley-icn.png" className="grass-icn" alt=""/>
                                </div>
                                ...
                                <div className="misc d-flex align-items-end justify-content-between mt-4">
                                    <div className="quantity d-flex align-items-center justify-content-between">
                                        <button className="qty-btn dec-qty"><img src="assets/img/icon/minus.svg"
                                                alt="minus"/></button>
                                        <input className="qty-input" type="number" name="qty" value="1" min="0"/>
                                        <button className="qty-btn inc-qty"><img src="assets/img/icon/plus.svg"
                                                alt="plus"/></button>
                                    </div>
                ...
                <div className="container">
                    <div className="tab-list product-tab-list">
                        <nav className="nav product-tab-nav">
                            ...
                            <Link className="product-tab-link tab-link" to="#pshipping" data-bs-toggle="tab">Shipping &
                                Returns</Link>
                            <Link className="product-tab-link tab-link" to="#pstyle" data-bs-toggle="tab">Style with</Link>
                            <Link className="product-tab-link tab-link" to="#preview" data-bs-toggle="tab">Reviews</Link>
                        </nav>
                    </div>
                        ...
                        <div className="col-lg-4">
                            <div className="product-card shadow-sm">
                                <div className="product-card-img text-center">
                                    <Link className="hover-switch" to="/">
                        ...
                        <div className="col-lg-4">
                            <div className="product-card shadow-sm">
                                <div className="product-card-img text-center">
                                    <Link className="hover-switch" to="/">
                                        <img className="primary-img product-img"
                                            src="assets/img/products/insidelogic-album-sense.png" alt="product-img"/>
                                    </Link>
