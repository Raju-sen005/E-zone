                                ...
                                <div className="product-img-large">
                                    <div className="img-large-slider common-slider" data-slick='{
                                        ...
                                        <div className="img-large-wrapper">
                                            <a href="assets/img/products/edius-5.jpg" data-fancybox="gallery">
                                                <img src="assets/img/products/edius-5.jpg" alt="img"/>
                                            </a>
                                        </div>
                                        <div className="img-large-wrapper">
                                            <a href="assets/img/products/edius-2.jpg" data-fancybox="gallery">
                                                <img src="assets/img/products/edius-2.jpg" alt="img"/>
                                            </a>
                                        </div>
                                        <div className="img-large-wrapper">
                                            <a href="assets/img/products/edius-3.jpg" data-fancybox="gallery">
                                                <img src="assets/img/products/edius-3.jpg" alt="img"/>
                                            </a>
                                        </div>
                                        <div className="img-large-wrapper">
                                            <a href="assets/img/products/edius-4.jpg" data-fancybox="gallery">
                                                <img src="assets/img/products/edius-4.jpg" alt="img"/>
                                            </a>
                                        </div>
                                        <div className="img-large-wrapper">
                                            <a href="assets/img/products/edius-1.jpg" data-fancybox="gallery">
                                                <img src="assets/img/products/edius-1.jpg" alt="img"/>
                                            </a>
                                        </div>
                                        <div className="img-large-wrapper">
                                            <a href="assets/img/products/edius-6.jpg" data-fancybox="gallery">
                            ...
                            <div className="product-card shadow-sm">
                                <div className="product-card-img text-center">
                                    ...
                                    <div className="product-card-action product-card-action-2">
                                        ...
                                        <a href="cart.html" className="addtocart-btn btn-primary"
                                            onclick="addToCart('Gold Projects Edit Zone')">ADD TO CART</a>
                                    </div>
                            ...
                            <div className="product-card shadow-sm">
                                <div className="product-card-img text-center">
                                    ...
                                    <div className="product-card-action product-card-action-2">
                                        ...
                                        <a href="cart.html" className="addtocart-btn btn-primary"
                                            onclick="addToCart('Album Sense')">ADD TO CART</a>
                                    </div>
                            ...
                            <div className="product-card shadow-sm">
                                <div className="product-card-img text-center">
                                    ...
                                    <div className="product-card-action product-card-action-2">
                                        ...
                                        <a href="cart.html" className="addtocart-btn btn-primary"
                                            onclick="addToCart('Cut Sense')">ADD TO CART</a>
                                    </div>
