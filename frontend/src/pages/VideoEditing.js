            ...
            <div className="container">
                ...
                <div className="row mt-4 pt-4">
                    ...
                    <div className="col-lg-6">
                        ...
                        <img src="assets/img/video/about-video.jpg" className="img-fluid py-4 " alt=""/>
                            ...
                            <table className="table table-bordered custom-table">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>10:00:00 AM</td>
                                  <td className="book-demo"><a href="/" data-bs-toggle="modal" data-bs-target="#exampleModal">Book Demo</a></td>
                                </tr>
                                <tr>
                                  <td>15-04-2025</td>
                                  <td>Recat Js</td>
                            ...
                            <div className="accordion-item rounded-3 border-0 shadow mb-2">
                              <h2 className="accordion-header">
                                <button className="accordion-button border-bottom collapsed fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                                 <h6>Module 1 – Digital Designing & Image Editing</h6>
                                </button>
                              </h2>
                              <div id="flush-collapseOne" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                <div className="accordion-body fs-6">
                                  <p>This is the first module of our video editing course that begins with the teaching of digital media designing and image editing. Essential software that will be covered in this module are Adobe Photoshop and Bridge.</p>
                            ...
                            <div className="accordion-item rounded-3 border-0 shadow mb-2">
                              <h2 className="accordion-header">
                                <button className="accordion-button border-bottom collapsed fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">
                                 <h6> Module 2 – Motion Graphics</h6>
                                </button>
                              </h2>
                              <div id="flush-collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                <div className="accordion-body fs-6">
                                  <p>Module two is all about motion graphics and compositing. Here you will get basic to advanced knowledge of motion graphics and compositing. The main software for this module is Adobe After Effects which is a leading software for compositing and motion graphics.</p>
                                  <p> <strong>Key Takeaways:</strong></p>
                            ...
                            <div className="accordion-item rounded-3 border-0 mb-2 shadow">
                              <h2 className="accordion-header">
                                <button className="accordion-button border-bottom collapsed fw-semibold" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">
                                  <h6>Module 3 – Non-Linear Editing</h6>
                                </button>
                              </h2>
                              <div id="flush-collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                <div className="accordion-body">
                                  <p>Module 3 teaches video editing techniques according to the non-linear editing method which is in trend nowadays. The main application for this module is Adobe Premiere Pro and it also covers Media Encoder.</p>
                                  <p> <strong>Key Takeaways:</strong></p>
                                  <strong>Video Editing with Adobe Premiere Pro</strong>
                                  <p>You will learn the process of rearranging, adding, and subtracting the video shots/clips to create a good flow of story using Premiere Pro. You will also learn color correction, filters, and transition creation between clips.</p>
